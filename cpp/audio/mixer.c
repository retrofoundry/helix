...
// Test-support hook (M3 golden gate): zero the shared mixer state so each dispatch
// path runs from an identical clean slate. Not referenced by the runtime.
void hlx_mixer_reset_state(void) {
